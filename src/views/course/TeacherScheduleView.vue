      ...
      <template #header>
        <div class="card-header">
          ...
          <div class="toolbar">
            ...
            <el-date-picker v-model="weekAnchor" type="date" value-format="YYYY-MM-DD" @change="loadList" />
...
const list = ref([])
const weekAnchor = ref(formatDate(new Date()))
...
async function loadList() {
  const res = await getTeacherSchedule({ weekStart: getMonday(weekAnchor.value) }).catch(() => ({ list: [] }))
  list.value = res?.list ?? []
}
